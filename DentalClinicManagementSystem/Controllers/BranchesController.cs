namespace DentalClinicManagementSystem.Controllers
{
    ...
    public class BranchesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Name,Address,DateAdded,DateModified,Status")] Branch branch)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Name,Address,DateAdded,DateModified,Status")] Branch branch)
        {
            if (ModelState.IsValid)
            {
                branch.DateModified = DateTime.Now;
