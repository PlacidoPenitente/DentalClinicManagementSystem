...
namespace DentalClinicManagementSystem.Controllers
{
    public class AdministratorsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,DateAdded,DateModified,Status,Username,Password,SecurityQuestion1,SecurityQuestion2,SecurityQuestion3,Answer1,Answer2,Answer3")] Administrator administrator)
        {
